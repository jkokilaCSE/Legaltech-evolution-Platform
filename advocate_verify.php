...
<div class="container mt-5 text-left bg-light" class="text-left" style="width:700px; margin:0 auto;">
<form action="" class="form-group" method="POST">
<label class="text-left">Enter Advocate ID:</label><br />
<input type="text" class="form-control" name="adv_id" placeholder="Enter Advocate  ID" required/>
<button type="submit" class="mt-2 btn form-control btn-outline-success" name="submit">Submit</button>
</form>    

<?php
if (isset($_POST['adv_id']) && $_POST['adv_id']!="") {
	$adv_id = $_POST['adv_id'];
	$url = "http://localhost/rest/api/".$adv_id;
	...
	echo "<tr><td>Advocte ID  </td><td>-$result->adv_id</td></tr>";
	echo "<tr><td>Name  </td><td>-$result->adv_name</td></tr>";
	echo "</table>";
