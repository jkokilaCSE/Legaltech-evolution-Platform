    ...
    <nav id="header" class="navbar navbar-expand-md navbar-light sticty-top">
        ...
        <div id="navbarRes" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
               ...
               <center><li class="nav-item"> <a href="about.php" class="nav-link">About us</a> </li></center>
               <center><li class="nav-item"> <a href="service.php" class="nav-link">Our Sevice</a> </li></center>
               <center><li class="nav-item"> <a href="gallery.php" class="nav-link">Gallery</a> </li></center>
               ...
               <div class="btn-group">
                    ...
                    <div class="bg-dark dropdown-menu dropdown-menu-right">
                        ...
                        <button class="dropdown-item" type="button"><a href="lawyer_login.php" class="nav-link">Lawyer Login</a></button>
                    </div>
                    </div>
                </li>
               </center>
    ...
    <div id="" class="w-50 m-auto mt-5">
            ...
            <?php
                if(isset($_POST["submitotp"]))
                {
                    ...
                    $select_sql_otp = "SELECT * FROM `user` WHERE email=? AND verification='0'";
                    ...
                    if($opt==$otp_fetch)
                    {
                        $update_user_table ="UPDATE `user` SET `verification`='1' WHERE email='$otp_emailid'";
                        mysqli_query($con,$update_user_table);
                        echo"<script type='text/javascript'>swal('OTP Verified','  ','success').then(function(){ window.location = 'user_login.php'});</script>";
