        ...
        ?>         
            <div id="hire_lawyer_small_box" class="container m-auto bg-light p-3 row">
                ...
                <div class="col text-left">
                    ...
                    <h5><i class="fa fa-star text-warning"></i> <span class="text-warning"><?php echo $advocate_fetch_rate; ?></span>  </h5>
                    ...
                    <a href="consult_lawyer_details.php?data=<?php echo $advocate_fetch_sno; ?>" class="btn btn-info w-50">Consult Now </a>
