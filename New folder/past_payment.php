...
<div id="dashboardfull" class="bg-white row">
    ...
    <?php
        ...
        $cnr_select = "SELECT * FROM `transaction` WHERE  `case_client_email`='$session_email' AND `status`='completed' ";
        ...
        <div class="row container bg-light p-3">
            ...
            <div class="col-md">
             <a href="print_invoice.php?transaction_id=<?php echo $transaction_case_sno; ?>&cnr_number=<?php echo $cnr_number; ?>" class="btn btn-dark">Print Invoice</a> 
            </div>
