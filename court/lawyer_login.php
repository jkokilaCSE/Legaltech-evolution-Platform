...
<body>
    <div style=" background: linear-gradient(to bottom, #0f0c29, #302b63, #24243e);">
        ...
        <div id="head" class="container-fluid">
            <div id="phone">
                <p class="text-white"><i class="fa fa-mobile text-white"> </i> +91 99410-99140 &nbsp;&nbsp;&nbsp;|
                    &nbsp;&nbsp;&nbsp; <i class="fa fa-phone-square text-white"> </i> &nbsp; +91 866 733 6507 |
                    &nbsp;&nbsp;&nbsp; <i class="fa fa-envelope text-white"> </i> &nbsp; contact@ccm.com </p>
            </div>
        </div>
        ...
        <nav id="header" class="navbar navbar-expand-md navbar-light sticty-top">
            ...
            <div id="navbarRes" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <center>
                        <li class="nav-item"> <a href="hire_lawer.php" class="nav-link">Hire a Advocate</a> </li>
                    </center>
                    <center>
                        <li class="nav-item"> <a href="new_lawyer.php" class="nav-link">Became a Advocate</a> </li>
                    </center>
                    <center>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="bg-dark dropdown-menu dropdown-menu-right">
                                    <button1 class="dropdown-item" type="button"><a href="user_login.php"
                                            class="nav-link">User Login</a></button1>
        ...
        <!-- <div id="login" class="container jumbotron  mt-5">
            <div id="logbox" class=" col-xl-6 m-auto">
                ...
                <form action="" method="post" class="form-group">
                    ...
                    <input type="submit" name="submitlog" value="Log in" class="btn btn-success btn-md mt-3 w-25"> <br>
                    <br>
                </form>
                <div class="row">
                    <div class="col">
        ...
        <div class="main">
            ...
            <div class="signup">
                <form method="post" class="form-group" id="form_id">
                    ...
                    <input type="text" name="enrol_num" id="username" placeholder="Enter your Bar Council ID...."
                        id="useremail" required="">
                    <input type="email" name="useremail" id="useremail" placeholder="Email" required="">
                    <input type="number" name="usermobile" placeholder="Mobile No  ........" id="usermobile"
                        required="">
                    <input type="password" name="userpass1" id="userpass1" placeholder="Password" required="">
                    <input type="password" name="userpass2" id="userpass2" placeholder="Confirm Password" required="">
                    <!-- <input type='checkbox' required name='checkbox' required> <a href='tems_conditions.php'
                        target="_block" class="text-white"> I have read the terms and conditions </a> <br> -->
            ...
            if (strlen(trim($userpass1)) < 6) {
                ...
                if (strlen(trim($usermobile)) < 10) {
                    ...
                    if ($userpass1 == $userpass2) {
                        $check_email_alredy_exits_select = "SELECT `email` FROM `lawyer_register` WHERE email='$useremail'";
                        ...
                        if (mysqli_num_rows($check_email_alredy_exits_mysqli_query) == 0) {
                            ...
                            $unique_number = "SELECT * FROM `advocate_unique_number` WHERE `unique_number`='$enrol_num'";
                            $unique_number_query = mysqli_query($con, $unique_number);
                            if (mysqli_num_rows($unique_number_query) == 1) {

                                $verify_key = '0';
                                $newusersqlinsert = "INSERT INTO `lawyer_register`(`sno`, `name`, `email`, `mobile`, `password`, `cpassword`,`vkey`,`verification`) VALUES (NULL,?,?,?,?,?,?,?)";
                                ...
                                if (mysqli_stmt_prepare($statement, $newusersqlinsert)) {
                                    ...
                                    if (mysqli_stmt_execute($statement)) {
                                        echo "<script type='text/javascript'> swal('SUCCESS!', 'Verification OTP Sended to Your Registed Email Address', 'success').then(function(){ window.location='verify_email_lawyer.php?emailid=$useremail'}); </script>";
                                ...
                                echo "<script type='text/javascript'> swal('Fails!', 'Your enrolment number and name is missmatch !', 'error'); </script>";
                            }
