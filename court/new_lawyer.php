...
<div id="login" class="container jumbotron">
        <div id="logbox" class="border border-white col-xl-6 m-auto">
                <h4 class="text-white">New Advocate Registeration</h4>
            <form method="post" class="form-group" id="form_id">
                    ...
                    <input type="text" name="enrol_num" required class="form-control mt-2" placeholder="Enter your Bar Council ID...." id="useremail">
                    ...
                    <a href="new_lawyer.php" class="text-primary">Already Registered Advocate</a>
            </form> 
