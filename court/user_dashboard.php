    ...
    <center>
        <div id="dashboardfull" class="bg-white row">
            ...
            <div id="sidebar" class="sidenav bg-dark">
                ...
                <a href="browse.php"><i class="fas fa-book"> </i> &nbsp;&nbsp;braille</a>
            ...
            <div id="dashboard">
                ...
                $case_select = "SELECT * FROM `case_detail` WHERE `case_client_email`='$case_client_email' AND `case_status`='current'";
                ...
                <div class="container-fluid mt-2 row">
                    ...
                    <?php
                    $advocate_select = "SELECT * FROM `my_advocate` WHERE `case_client_email`='$case_client_email'";
                    $advocate_query = mysqli_query($con, $advocate_select);
                    $advocate_count = mysqli_num_rows($advocate_query);
                    ?>

                    <div id="dashconbox" class="col-md m-2 p-3">
                        <h3 class="text-dark">My Advocates </h3>
                        <h1 class="" style="font-size:60px;">
                            <?php echo "$advocate_count"; ?>
                        </h1>
