...
<div id="login" class="container jumbotron">
        <div id="logbox" class="border border-white col-xl-6 m-auto">
            ...
            <form method="post" class="form-group" id="form_id">
                    ...
                    <input type="text" name="enrol_num" required class="form-control mt-2" placeholder="Enter your Enrolment Number...." id="useremail">
         ...
         if($userpass1 == $userpass2){
             ...
             if(mysqli_num_rows($check_email_alredy_exits_mysqli_query)==0){
                ...
                if(mysqli_num_rows($unique_number_query)==1)
                {
                    ...
                    echo "<script type='text/javascript'> swal('Fails!', 'Unique ID not found !', 'error'); </script>";
                }
