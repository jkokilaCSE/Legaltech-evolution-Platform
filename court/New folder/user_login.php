    ...
    <div id="login" class="container jumbotron  mt-5">
        <div id="logbox" class=" col-xl-6 m-auto">
            ...
            <form action="" method="post" class="form-group">
                    <input type="email" name="logemail" class="form-control mt-2" required placeholder="Enter your email id ........">
                    <input type="password" name="logpass" class="form-control mt-2" required placeholder="Enter your password ........">
                    <input type="submit" name="submitlog" value="Log in" class="btn btn-success btn-md mt-3 w-25"> <br> <br>
            </form> 
            <div class="row">
            <div class="col">
                <a href="new_user.php" class="text-info">new user registration </a>
            </div>
            <div class="col">
