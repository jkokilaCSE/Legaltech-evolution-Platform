...
<div id="dashboardfull" class="bg-white row">
    ...
    <div class="p-3 container">
        <form action="" class="form-group" method="post">
            ...
            <div class="row p-3">
                <div class="col-md">
                <label  for="case_" class="float-left">First Name Over Whom</label>
                <input type="text" name="first_name_over_whom" placeholder="Enter First Name Name Over Whom ....." class="form-control" id="case_title">
                </div>
                <div class="col-md">
                <label  for="case_title" class="float-left">Second Name Over Whom</label>
                <input type="text" name="second_name_over_whom" placeholder="Enter Second Name Name Over Whom ....." class="form-control" id="case_title">
                </div>
            </div>

            <label  for="opponent_address" class="float-left">Opponent Address</label>
            <textarea name="acquest_address" class="form-control" id="opponent_address" style="resize:none" placeholder="Enter your opponent address ..." cols="15" rows="5"></textarea>
         ...
         <label  for="opponent_mobile" class="float-left">Acquest Mobile Number</label>
         <input type="text" name="acquest_mobile" placeholder="Enter Opponent mobile Number....." class="form-control" id="opponent_mobile">
         
         <label  for="opponent_email" class="float-left">Acquest Email Id</label>
         <input type="text" name="acquest_email" placeholder="Enter Opponent e-mail id....." class="form-control" id="opponent_mobile">
