...
<div id="dashboardfull" class="bg-white row">
    ...
    <button href="javascript:void(0)" class="closebtn btn btn-light float-right" onclick="closeNav()">&times;</button>
            ...
            <a href="#"><i class="fa fa-gavel "> </i>&nbsp;&nbsp; Consult Now</a>
            <a href="#"><i class="fa fa-user">  </i> &nbsp;&nbsp;My Profile</a>
            <a href="my_case.php"><i class="fa fa-users">  </i >&nbsp;&nbsp;My Cases</a>
            <a href="#"><i class="fas fa-book">  </i> &nbsp;&nbsp;My Documents</a>
            <a href="#"><i class="fa fa-globe">  </i> &nbsp;&nbsp;Transactions</a>
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3907.820040324838!2d92.716941!3d11.63617!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xc1303faa63212a2d!2sDr.%20B.R.%20Ambedkar%20Institute%20of%20Technology!5e0!3m2!1sen!2sus!4v1579713799390!5m2!1sen!2sus" style="border:0;height:650px;width:100%"  allowfullscreen></iframe>
</div>
</div>
</div>
