        ...
        <div id="dashboardfull" class="bg-white row">
            ...
            <div id="dashboard">
                ...
                <div id="login" style="background:url('images/bann1.jpg');background-size:cover;"
                    ...
                    <h2 class="text-white text-center">CONSULT AN TOP RATED ADVOCATE'S IN ONLINE OR BY OFFLINE</h2> <br>
                            ...
                            <div class="col text-left">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <h5><i class="fa fa-star text-warning"></i> <span class="text-warning">
                                    ...
                                    <div class="col-md">
                                        <div class="row">
                                            <div class="col-1" style="font-size:25px;margin-top:10px;">
                                                <i class="fa fa-phone"></i>
                                            </div>
                                            <div class="col">
                                                <h6>Voice Consultation</h6>
                                                <h6>₹ 1000 / 30 Minutes</h6><br>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <h6>₹ 1000 / 30 Minutes</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <a href="consult_lawyer_details.php?data=<?php echo $advocate_fetch_sno; ?>"
                                    class="btn btn-info w-50">Consult Now </a>
                                ...
                                <form action="" method="post" class="form-group">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control " name="cat">
                                            ...
                                            <option value="immigration"> Immigration</option>
                                            <option value="insurance"> Insurance</option>
                                            <option value="intellectual-property-rights-ipr"> Intellectual Property
                                                Rights
                                                (IPR)
                                            </option>
                                            <option value="international-law"> International Law</option>
                                    ...
                                    <div class="form-group">
                                        <select class="form-control w-50 selectForm" name="city">
                                            ...
                                            <option value="thiruvanathapuram">Thiruvanathapuram</option>
                                            <option value="territories" disabled>UNION TERRITORIES</option>
                                            <option value="andaman_and_nicobar_islands">Andaman and Nicobar Islands
                                            </option>
                                            <option value="chandigarh">Chandigarh</option>
                                            <option value="dadra_and_nagar_haveli">Dadra and Nagar Haveli</option>
                                            <option value="daman_and_div">Daman and Div</option>
                                            ...
                                            <div class="card profile-card-2">
                                                ...
                                                <div class="card-body pt-5">
                                                    <img src="https://via.placeholder.com/110x110" alt="profile-image"
                                                        class="profile">
                                                    <h5 class="card-title">Mark Stern
                                                        <?php echo $advocate_fetch_name; ?>
                                                    </h5>
                                                    <h5><i class="fa fa-map-marker"></i>
                                                        <?php echo $advocate_fetch_location; ?>
                                                ...
                                                <div class="col-md">
                                                    <div class="row">
                                                        <div class="col-2" style="font-size:25px;margin-top:10px;">
                                                            <i class="fa fa-phone"></i>
                                                        </div>
                                                        <div class="col">
                                                            <h6>Voice Consultation</h6>
