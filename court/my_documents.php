    ...
    <center>
        <div id="dashboardfull" class="bg-white row">
            ...
            <div id="dashboard">
                ...
                $cnr_select = "SELECT * FROM `case_detail` WHERE `case_client_email`='$session_email'";
                $cnr_result = mysqli_query($con, $cnr_select);

                ?>

                <div class="container p-2 mt-3">
                    <h3 class="mb-3">Add New Case Documents</h3>
                    <form action="" method="post" enctype="multipart/form-data" class="form-group">
                        <div class="row">
                            <div class="col-md">
                                <select required name="case_cnr_number" id="" class="form-control ">
                                    <?php
                                    while ($cnr_fetch_row = mysqli_fetch_assoc($cnr_result)) {
                                        $cnr_number = $cnr_fetch_row["case_cnr_number"];
                                        ?>
                                        <option value="<?php echo $cnr_number; ?>"> CNR-
                                            <?php echo $cnr_number; ?>
                                        </option>
                                        <?php
                                    }
                            ...
                            <div class="col-md">
                                <input type="file" required name="case_document" class="form-control" id="">
                            </div>
                            <input type="submit" name="case_submit" value="Add Document"
                                class="form-control mt-3 btn btn-success m-3">
                        </div>
                    </form>

                    <?php
                    if (isset($_POST["case_submit"])) {
                        $cnr_selected_number = $_POST["case_cnr_number"];

                        $product_case_document = $_FILES['case_document']['name'];
                        $product_case_tmp_document = $_FILES['case_document']['tmp_name'];

                        $upload = "case_files/";

                        move_uploaded_file($product_case_tmp_document, $upload . $product_case_document);

                        $document_insert = "INSERT INTO `case_documents`(`sno`, `cnr_number`, `document_name`, `petitioner_email`,`date_time`) VALUES (NULL,?,?,?,NOW())";
                        $stmt_pro_insert = mysqli_stmt_init($con);
                        mysqli_stmt_prepare($stmt_pro_insert, $document_insert);
                        mysqli_stmt_bind_param($stmt_pro_insert, "sss", $cnr_selected_number, $product_case_document, $session_email);
                        if (mysqli_stmt_execute($stmt_pro_insert)) {
                            echo "<script type='text/javascript'> swal('Document Added Success!', 'your Case Document will successfully Added', 'success');</script>";
                        } else {
                ...
                <h2 class="text-left container">My Documents</h2>

                <div class="container bg-light p-3">
                    <?php
                    $cnr_select1 = "SELECT * FROM `case_detail` WHERE `case_client_email`='$session_email'";
                    $cnr_result1 = mysqli_query($con, $cnr_select1);

                    while ($cnr_fetch_row1 = mysqli_fetch_assoc($cnr_result1)) {
                        $cnr_number1 = $cnr_fetch_row1["case_cnr_number"];
                        ?>
                        ...
                        <div class="container p-3 bg-light">
                            <div class="row">
                                <div class="col-md">
                                    <h5 class="">
                                        <?php echo $cnr_number1; ?>
                                    </h5>
                                </div>

                                <div class="col-md">
                                    <a href="my_full_document_view.php?case_cnr_no=<?php echo $cnr_number1; ?>"
                                        class="btn btn-info form-control">View All Document</a>
                                </div>

                                <div class="col-md">
                                    <a href="#" class="btn btn-danger form-control">Delete All Document</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    while ($cnr_fetch_row1 = mysqli_fetch_assoc($cnr_result1)) {
                                        ...
                                        <div class="container p-3 bg-light">
                                            <div class="row">
                                                ...
                                                <div class="col-md">
                                                    <a href="#" class="btn btn-danger form-control">Delete All
                                                        Document</a>
                                                </div>
                                            </div>
                                        </div>
