            ...
            <div class="row">
                    <div class="col-md">
                        <select required name="case_cnr_number" id="" class="form-control ">
                            ...
                            ?>
                            <option value="<?php echo $cnr_number; ?>"> CNR-<?php echo $cnr_number; ?></option>
                            <?php
                                }
                            ?>
                        </select>
                    ...
                    <input type="submit" name="case_submit" value="Add Document" class="form-control mt-3 btn btn-success m-3">
               </div>
            </form>
                ...
                while($cnr_fetch_row1 = mysqli_fetch_assoc($cnr_result1)){
                 ...
                 <div class="container p-3 bg-light">
                    <div class="row">                    <div class="col-md">
                        <h5 class=""><?php echo $cnr_number1 ; ?></h5> 
                        </div>

                        <div class="col-md">
                        <a href="my_full_document_view.php?case_cnr_no=<?php echo $cnr_number1; ?>" class="btn btn-info form-control">View All Document</a>
                        </div>
