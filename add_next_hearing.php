...
<div id="dashboardfull" class="bg-white row">
    ...
    <div class="bg-light">
        <h4 class="text-dark">Add Next Hearing of your cases</h4>
    </div>

    <div class="container text-left mt-5">
        <form action="" class="form-group" method="post">
        <label for="" class="text-left">Enter CNR number</label>
           <select name="" class="form-control" id="">
                <option value="">MAC45987654</option>
           </select>
            <label for="" class="mt-4">Next hearing date</label>
           <input type="date" name="next_hearing_date" placeholder="Enter your next hearing date ......" class="form-control mt-1" id="">

            <input type="submit" value="Add next hearing date " name="submit_next_hearing" class="btn btn-success form-control mt-3">
